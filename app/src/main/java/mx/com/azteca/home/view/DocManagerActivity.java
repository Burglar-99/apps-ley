...
import mx.com.azteca.home.view.ipati.BaseActivity;
import mx.com.azteca.home.view.ipati.itemanimator.CustomItemAnimator;

public class DocManagerActivity extends mx.com.azteca.home.view.BaseActivity<CDocumentInstance> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras().containsKey("documento")) {
            this.idDocumento    = getIntent().getExtras().getInt("documento");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            cDocumentInstance.verificarDocumento(docInfo.IdDocumento, docInfo.Fecha, docInfo.Folio, user, passwd, imei);
        }
